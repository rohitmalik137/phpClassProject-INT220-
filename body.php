  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/banner11.jpg" alt="Los Angeles" style="width:100%;">
        
      </div>
    
      <div class="item">
        <img src="img/banner12.jpg" alt="New York" style="width:100%;">
        
      </div>
      <div class="item">
        <img src="img/banner13.jpg" alt="New York" style="width:100%;">
        
      </div>
      <div class="item">
        <img src="img/banner14.jpg" alt="New York" style="width:100%;">
        
      </div>
	  <div class="item">
        <img src="img/banner15.jpg" alt="New York" style="width:100%;">
        
      </div>
	  <div class="item">
        <img src="img/banner16.jpg" alt="New York" style="width:100%;">
